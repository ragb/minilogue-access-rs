...
//! build dump-request frames, `.mnlgprog`/`.mnlglib` import/export, and YAML
//! conversion. The typed [`Program`], [`GlobalArea`], [`ProgInfo`] and
//! [`MnlgProgram`] cross the boundary as TypeScript objects via `tsify`.
